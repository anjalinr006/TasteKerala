...
<div>
	<div class="breadcrumb-area">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <img src={require('./img/core-img/breadcrumb-line.png')} alt=""/>
                ...
                <div class="col-12 col-lg-8">
                    <div class="blog-posts-area">
                            ...
                            <div class="post-content">
                                ...
                                <blockquote>
                                    <div class="blockquote-icon">
                                        <img src={require('./img/core-img/quote.png')} alt=""/>
                                    </div>
                        ...
                        <div class="related-posts clearfix">
                            <div class="curve-line bg-img mb-50" style={{backgroundImage: "url("+require('./img/core-img/breadcrumb-line.png')+")" }}></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="single-blog-post related-post">
                                        <div class="post-thumbnail mb-50">
                                            <a href="#"><img src={require('./img/blog-img/13.jpg')} alt=""/></a>
                                        </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="single-blog-post related-post">
                                        <div class="post-thumbnail mb-50">
                                            <a href="#"><img src={require('./img/blog-img/14.jpg')} alt=""/></a>
                                        </div>
                                        <div class="post-content mb-50">
                            ...
                            <div class="curve-line bg-img" style={{backgroundImage: "url("+require('./img/core-img/breadcrumb-line.png')+")" }}></div>
                        </div>
                        ...
                        <div class="comment_area clearfix">
                            ...
                            <ol>
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-flex">
                                        <div class="comment-author">
                                            <img src={require('./img/blog-img/15.jpg')} alt=""/>
                                        </div>
                                    ...
                                    <ol class="children">
                                        <li class="single_comment_area">
                                            <div class="comment-wrapper d-flex">
                                                <div class="comment-author">
                                                    <img src={require('./img/blog-img/16.jpg')} alt=""/>
                                                </div>
                                                <div class="comment-content">
                                                    <span class="comment-date">27 Aug 2018</span>
                                                    <h5>John Doe</h5>
                                ...
                                <li class="single_comment_area">
                                    <div class="comment-wrapper d-flex">
                                        <div class="comment-author">
                                            <img src={require('./img/blog-img/17.jpg')} alt=""/>
                                        </div>
                                        <div class="comment-content">
                                            <span class="comment-date">27 Aug 2018</span>
                                            <h5>Michen Jason</h5>
